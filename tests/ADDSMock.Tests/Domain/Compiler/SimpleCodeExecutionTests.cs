...
";
            ...
            System.Console.WriteLine($"Error: {script.Error}");
...
";
        ...
        public void EvaluateTest()
        {
            ...
            System.Console.WriteLine($"Error: {script.Error}");
            System.Console.WriteLine(script.ErrorMessage);
            System.Console.WriteLine(script.GeneratedClassCode);
...
";
        ...
        public async Task ExecuteCodeWithDynamicModelAsync()
        {
            ...
            script.AddNamespace("ADDSMock.Tests");
...
";
            ...
            System.Console.WriteLine($"Result: {execResult}");
            System.Console.WriteLine($"Error: {script.Error}");
            System.Console.WriteLine(script.ErrorMessage);
            System.Console.WriteLine(script.GeneratedClassCodeWithLineNumbers);
...
{{
    ...
    return result;
            ...
            System.Console.WriteLine($"Result: {result}");
            System.Console.WriteLine($"Error: {exec.Error}");
            System.Console.WriteLine(exec.ErrorMessage);
            System.Console.WriteLine(exec.GeneratedClassCode);
...
{{
    ...
    return json;
            ...
            System.Console.WriteLine($"Result: {result}");
            System.Console.WriteLine($"Error: {script.Error}");
            System.Console.WriteLine($"Error Message: {script.ErrorMessage}");
            System.Console.WriteLine(script.GeneratedClassCode);
...
{{
    ...
    return result;
            ...
            System.Console.WriteLine(exec.LastException.StackTrace);
...
";
        ...
        public void ExternalAssemblyTest()
        {
            ...
            script.AddAssembly("ReferenceTest.dll");
            ...
            script.AddNamespace("ReferenceTest");

            // Add this Namespace for class reference below
            script.AddNamespace("ADDSMock.Tests.Domain.Compiler");
...
{{
    ...
    return result;
            ...
            System.Console.WriteLine($"Result: {result}");
            System.Console.WriteLine($"Error: {script.Error}");
            System.Console.WriteLine($"Message: {script.ErrorMessage}");
            System.Console.WriteLine($"Type: {script.ErrorType}");
            System.Console.WriteLine($"stack: " + script.LastException?.StackTrace);
            System.Console.WriteLine($"    inner: " + script.LastException?.InnerException?.StackTrace);
...
";
            ...
            System.Console.WriteLine("Location: " + personType.Assembly.Location);
            ...
            System.Console.WriteLine(customerType);
            System.Console.WriteLine(customerType.Assembly.Location);
            ...
            System.Console.WriteLine(customer.CustomerInfo.Name);
        }
    }
