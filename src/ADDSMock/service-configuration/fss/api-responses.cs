    ...
    server
        .Given(
            Request.Create()
                ...
                .UsingPost()
                .WithBody(new RegexMatcher(@".*"))
                .WithHeader("_X-Correlation-ID", "400-badrequest-guid-fss")
        )
        .RespondWith(
            Response.Create()
                .WithStatusCode(400)
    ...
    server
        .Given(
            Request.Create()
                ...
                .UsingPost()
                .WithBody(new RegexMatcher(@".*"))
                .WithHeader("_X-Correlation-ID", "401-unauthorised-guid-fss")
        )
        .RespondWith(
            Response.Create()
                .WithStatusCode(401)
    ...
    server
        .Given(
            Request.Create()
                ...
                .UsingPost()
                .WithBody(new RegexMatcher(@".*"))
                .WithHeader("_X-Correlation-ID", "403-forbidden-guid-fss")
        )
        .RespondWith(
            Response.Create()
                .WithStatusCode(403)
    ...
    server
        .Given(
            Request.Create()
                ...
                .UsingPost()
                .WithBody(new RegexMatcher(@".*"))
                .WithHeader("_X-Correlation-ID", "429-toomanyrequests-guid-fss")
        )
        .RespondWith(
            Response.Create()
                .WithStatusCode(429)
