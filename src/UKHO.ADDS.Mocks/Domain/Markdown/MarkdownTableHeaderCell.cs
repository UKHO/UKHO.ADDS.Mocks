...
namespace UKHO.ADDS.Mocks.Domain.Markdown
{
    ...
    public class MarkdownTableHeaderCell : MarkdownTextElement
    {
        ...
        public MarkdownTableHeaderCell(string text, MarkdownTableTextAlignment textAlignment) : base(text) => ColumnTextAlignment = textAlignment;
        ...
        /// <param name="inlineElement">The header cell text as markdown inline element.</param>
        /// <param name="textAlignment">The column text alignment.</param>
        public MarkdownTableHeaderCell(MarkdownInlineElement inlineElement, MarkdownTableTextAlignment textAlignment) : base(inlineElement) => ColumnTextAlignment = textAlignment;
