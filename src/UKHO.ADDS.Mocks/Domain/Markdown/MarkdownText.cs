...
namespace UKHO.ADDS.Mocks.Domain.Markdown
{
    ...
    public class MarkdownText : MarkdownInlineElement
    {
        ...
        public MarkdownText(string text) : base(text) => _fragments.Add(text);

        /// <summary>
        ///     Initializes a new instance of the <see cref="MarkdownText" /> class.
        /// </summary>
        /// <param name="inlineElement">The text as markdown inline element.</param>
        public MarkdownText(MarkdownInlineElement inlineElement) : base(inlineElement) => _fragments.Add(inlineElement);
