...
namespace UKHO.ADDS.Mocks.Domain.Files
{
    ...
    public struct FileSystemItem
    {
        ...
        private readonly InvalidOperationException NewThrowNotInitialized() => throw new InvalidOperationException("This instance is not initialized");

        /// <inheritdoc />
        public override string ToString() => AbsolutePath.FullName;
    }
}
