...
namespace UKHO.ADDS.Mocks.Domain.Files
{
    ...
    public readonly struct UPath : IEquatable<UPath>, IComparable<UPath>
    {
        ...
        internal static readonly UPath Null = new(null!);
        ...
        public bool IsEmpty => FullName?.Length == 0;
        ...
        public static implicit operator UPath(string path) => new(path);
        ...
        public static explicit operator string(UPath path) => path.FullName;
        ...
        public static explicit operator ReadOnlySpan<char>(UPath path) => path.FullName.AsSpan();
        ...
        /// </exception>
        /// <exception cref="System.ArgumentException">If an error occurs while trying to combine paths.</exception>
        public static UPath operator /(UPath path1, UPath path2) => Combine(path1, path2);

        /// <inheritdoc />
        public bool Equals(UPath other) => string.Equals(FullName, other.FullName);

        /// <inheritdoc />
        public override bool Equals(object? obj) => obj is UPath path && Equals(path);
        ...
        public static bool operator ==(UPath left, UPath right) => left.Equals(right);
        ...
        public ReadOnlySpan<char> AsSpan() => FullName.AsSpan();
        ...
        /// <inheritdoc />
        public int CompareTo(UPath other) => string.Compare(FullName, other.FullName, StringComparison.Ordinal);
    }
}
