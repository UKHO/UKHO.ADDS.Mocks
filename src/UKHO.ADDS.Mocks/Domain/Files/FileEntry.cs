...
{
    /// <summary>
    ///     Similar to <see cref="FileInfo" /> but to use with <see cref="IFileSystem" />, provides properties and instance
    ///     methods
    ...
    public class FileEntry : FileSystemEntry
    {
        ...
        /// <summary>
        ///     Copies an existing file to a new file on another <see cref="IFileSystem" />, allowing the overwriting of an
        ///     existing file.
        /// </summary>
        /// <returns>
        ///     A new file, or an overwrite of an existing file if <paramref name="overwrite" /> is true. If the file exists
        ...
        public Stream Create() => FileSystem.CreateFile(Path);
        ...
        ///     <paramref name="destFileName" /> contains a colon (:) in the middle of the string.
        /// </exception>
        public void MoveTo(UPath destFileName) => FileSystem.MoveFile(Path, destFileName);
        ...
        public Stream Open(FileMode mode, FileAccess access, FileShare share = FileShare.None) => FileSystem.OpenFile(Path, mode, access, share);

        /// <summary>
        ///     Replaces the contents of this file with the contents of another file, deleting the original file, and creating a
        ...
        /// </param>
        public void ReplaceTo(UPath destPath, UPath destBackupPath, bool ignoreMetadataErrors) => FileSystem.ReplaceFile(Path, destPath, destBackupPath, ignoreMetadataErrors);
        ...
        /// <returns>A string containing all lines of the file.</returns>
        public string ReadAllText(Encoding encoding) => FileSystem.ReadAllText(Path, encoding);
        ...
        /// </remarks>
        public void WriteAllText(string content) => FileSystem.WriteAllText(Path, content);
        ...
        /// </remarks>
        public void WriteAllText(string content, Encoding encoding) => FileSystem.WriteAllText(Path, content, encoding);
        ...
        /// </remarks>
        public void AppendAllText(string content) => FileSystem.AppendAllText(Path, content);
        ...
        ///     path parameter must contain existing directories.
        /// </remarks>
        public void AppendAllText(string content, Encoding encoding) => FileSystem.AppendAllText(Path, content, encoding);

        /// <summary>
        ///     Opens a file, reads all lines of the file with the specified encoding, and then closes the file.
        /// </summary>
        /// <returns>An array of strings containing all lines of the file.</returns>
        public string[] ReadAllLines() => FileSystem.ReadAllLines(Path);
        ...
        /// </remarks>
        /// <returns>An array of strings containing all lines of the file.</returns>
        public string[] ReadAllLines(Encoding encoding) => FileSystem.ReadAllLines(Path, encoding);
        ...
        /// </remarks>
        public void WriteAllBytes(byte[] content) => FileSystem.WriteAllBytes(Path, content);

        /// <inheritdoc />
        public override void Delete() => FileSystem.DeleteFile(Path);
    }
}
