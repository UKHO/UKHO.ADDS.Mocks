namespace UKHO.ADDS.Mocks.Domain.Files
{
    ...
    public class DirectoryEntry : FileSystemEntry
    {
        ...
        public void Create() => FileSystem.CreateDirectory(Path);
        ...
        public void Delete(bool recursive) => FileSystem.DeleteDirectory(Path, recursive);
        ...
        /// </exception>
        /// <exception cref="T:System.Security.SecurityException">The caller does not have the required permission. </exception>
        public IEnumerable<DirectoryEntry> EnumerateDirectories(string searchPattern = "*", SearchOption searchOption = SearchOption.TopDirectoryOnly) => FileSystem.EnumerateDirectoryEntries(Path, searchPattern, searchOption);
        ...
        /// </exception>
        /// <exception cref="T:System.Security.SecurityException">The caller does not have the required permission. </exception>
        public IEnumerable<FileEntry> EnumerateFiles(string searchPattern = "*", SearchOption searchOption = SearchOption.TopDirectoryOnly) => FileSystem.EnumerateFileEntries(Path, searchPattern, searchOption);
        ...
        public IEnumerable<FileSystemEntry> EnumerateEntries(string searchPattern = "*", SearchOption searchOption = SearchOption.TopDirectoryOnly, SearchTarget searchTarget = SearchTarget.Both) => FileSystem.EnumerateFileSystemEntries(Path, searchPattern, searchOption, searchTarget);
        ...
        /// </returns>
        public IEnumerable<FileSystemItem> EnumerateItems(SearchOption searchOption = SearchOption.TopDirectoryOnly, SearchPredicate? searchPredicate = null) => FileSystem.EnumerateItems(Path, searchOption, searchPredicate);
        ...
        public void MoveTo(UPath destDirName) => FileSystem.MoveDirectory(Path, destDirName);

        /// <inheritdoc />
        public override void Delete() => Delete(true);
    }
}
