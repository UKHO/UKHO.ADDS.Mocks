namespace UKHO.ADDS.Mocks.Domain.Files.FileSystems
{
    public class FileSystemWatcher : IFileSystemWatcher
    {
        ...
        ~FileSystemWatcher() => Dispose(false);
        ...
        protected virtual bool ShouldRaiseEventImpl(FileChangedEventArgs args) => args.FullPath.IsInDirectory(Path, IncludeSubdirectories);
        ...
        protected virtual UPath? TryConvertPath(UPath pathFromEvent) => pathFromEvent;
        ...
        private void OnError(object? sender, FileSystemErrorEventArgs args) => RaiseError(args);
