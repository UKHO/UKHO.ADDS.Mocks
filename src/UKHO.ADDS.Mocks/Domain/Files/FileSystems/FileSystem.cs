...
{
    /// <summary>
    ///     Abstract class for a <see cref="IFileSystem" />. Provides default arguments safety checking and redirecting to safe
    ///     implementation.
    ...
    public abstract class FileSystem : IFileSystem
    {
        ...
        ///     The default file time is 12:00 midnight, January 1, 1601 A.D. (C.E.) Coordinated Universal Time (UTC), adjusted to
        ///     local time.
        /// </summary>
        ...
        /// </summary>
        ~FileSystem() => DisposeInternal(false);
        ...
        /// <summary>
        ///     Implementation for <see cref="DirectoryExists" />, paths is guaranteed to be absolute and validated through
        ///     <see cref="ValidatePath" />.
        ...
        ///     are guaranteed to be absolute, not equal and different from root `/`, and validated through
        ///     <see cref="ValidatePath" />.
        ...
        /// <summary>
        ///     Implementation for <see cref="DeleteDirectory" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     different from root path `/` and validated through <see cref="ValidatePath" />.
        ...
        internal string DebuggerDisplayInternal() => DebuggerDisplay();

        internal string DebuggerKindName()
        {
            var typeName = GetType().Name.Replace("FileSystem", "fs").ToLowerInvariant();
        ...
        /// <summary>
        ///     Implementation for <see cref="ReplaceFile" />, <paramref name="srcPath" />, <paramref name="destPath" /> and
        ///     <paramref name="destBackupPath" />
        ///     are guaranteed to be absolute and validated through <see cref="ValidatePath" />.
        ...
        ///     <c>true</c> to ignore merge errors (such as attributes and access control lists
        ///     (ACLs)) from the replaced file to the replacement file; otherwise, <c>false</c>.
        /// </param>
        protected abstract void ReplaceFileImpl(UPath srcPath, UPath destPath, UPath destBackupPath, bool ignoreMetadataErrors);

        /// <summary>
        ///     Implementation for <see cref="GetFileLength" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ...
        /// <summary>
        ///     Implementation for <see cref="FileExists" />, <paramref name="path" /> is guaranteed to be absolute and validated
        ///     through <see cref="ValidatePath" />.
        ...
        /// <summary>
        ///     Implementation for <see cref="OpenFile" />, <paramref name="path" /> is guaranteed to be absolute and validated
        ///     through <see cref="ValidatePath" />.
        ///     Opens a file <see cref="Stream" /> on the specified path, having the specified mode with read, write, or read/write
        ///     access and the specified sharing option.
        /// </summary>
        /// <param name="path">The path to the file to open.</param>
        /// <param name="mode">
        ///     A <see cref="FileMode" /> value that specifies whether a file is created if one does not exist, and
        ...
        /// <returns>
        ///     A file <see cref="Stream" /> on the specified path, having the specified mode with read, write, or read/write
        ///     access and the specified sharing option.
        /// </returns>
        protected abstract Stream OpenFileImpl(UPath path, FileMode mode, FileAccess access, FileShare share);

        /// <summary>
        ///     Implementation for <see cref="GetAttributes" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ...
        /// <summary>
        ///     Implementation for <see cref="GetCreationTime" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ...
        /// <summary>
        ///     Implementation for <see cref="SetCreationTime" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ///     Sets the date and time the file was created.
        /// </summary>
        /// <param name="path">The path to a file or directory for which to set the creation date and time.</param>
        /// <param name="time">
        ///     A <see cref="DateTime" /> containing the value to set for the creation date and time of path. This
        ///     value is expressed in local time.
        /// </param>
        protected abstract void SetCreationTimeImpl(UPath path, DateTime time);

        /// <summary>
        ///     Implementation for <see cref="GetLastAccessTime" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ///     Returns the last access date and time of the specified file or directory.
        /// </summary>
        /// <param name="path">The path to a file or directory for which to obtain creation date and time information.</param>
        /// <returns>
        ///     A <see cref="DateTime" /> structure set to the last access date and time for the specified file or directory.
        ///     This value is expressed in local time.
        /// </returns>
        protected abstract DateTime GetLastAccessTimeImpl(UPath path);

        /// <summary>
        ///     Implementation for <see cref="SetLastAccessTime" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ...
        /// <param name="time">
        ///     A <see cref="DateTime" /> containing the value to set for the last access date and time of path.
        ///     This value is expressed in local time.
        /// </param>
        protected abstract void SetLastAccessTimeImpl(UPath path, DateTime time);

        /// <summary>
        ///     Implementation for <see cref="GetLastWriteTime" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ...
        /// <summary>
        ///     Implementation for <see cref="SetLastWriteTime" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ///     Sets the date and time that the specified file was last written to.
        /// </summary>
        /// <param name="path">The path to a file or directory for which to set the last write date and time.</param>
        /// <param name="time">
        ///     A <see cref="DateTime" /> containing the value to set for the last write date and time of path. This
        ///     value is expressed in local time.
        /// </param>
        ...
        /// <summary>
        ///     Implementation for <see cref="EnumeratePaths" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ///     Returns an enumerable collection of file names and/or directory names that match a search pattern in a specified
        ...
        ///     a combination of valid literal path and wildcard (* and ?) characters (see Remarks), but doesn't support regular
        ///     expressions.
        /// </param>
        ...
        ///     The search target either <see cref="SearchTarget.Both" /> or only
        ///     <see cref="SearchTarget.Directory" /> or <see cref="SearchTarget.File" />.
        /// </param>
        /// <returns>
        ///     An enumerable collection of file-system paths in the directory specified by path and that match the specified
        ///     search pattern, option and target.
        /// </returns>
        ...
        ///     Implementation for <see cref="EnumeratePaths" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ///     Returns an enumerable collection of <see cref="FileSystemItem" /> that match a search pattern in a specified path,
        ...
        ///     The search string to match against file-system entries in path. This parameter can
        ///     contain a combination of valid literal path and wildcard (* and ?) characters (see Remarks), but doesn't support
        ///     regular expressions.
        /// </param>
        /// <returns>
        ///     An enumerable collection of <see cref="FileSystemItem" /> in the directory specified by path and that match
        ///     the specified search pattern, option and target.
        /// </returns>
        ...
        /// <summary>
        ///     Implementation for <see cref="CanWatch" />, <paramref name="path" /> is guaranteed to be absolute and validated
        ///     through <see cref="ValidatePath" />.
        ...
        protected virtual bool CanWatchImpl(UPath path) => true;

        /// <summary>
        ///     Implementation for <see cref="Watch" />, <paramref name="path" /> is guaranteed to be absolute and valudated
        ///     through <see cref="ValidatePath" />.
        ///     Returns an <see cref="IFileSystemWatcher" /> instance that can be used to watch for changes to files and
        ///     directories in the given path. The instance must be
        ...
        /// <summary>
        ///     Implementation for <see cref="ConvertPathToInternal" />, <paramref name="path" /> is guaranteed to be absolute and
        ///     validated through <see cref="ValidatePath" />.
        ///     Converts the specified path to the underlying path used by this <see cref="IFileSystem" />. In case of a
        ///     <see cref="PhysicalFileSystem" />, it
        ...
        /// <summary>
        ///     Implementation for <see cref="ConvertPathToInternal" />, <paramref name="innerPath" /> is guaranteed to be not null
        ///     and return path to be validated through <see cref="ValidatePath" />.
        ...
        ///     Resolves the specified path to a path in the underlying file system, if one exists. For instance, a
        ///     <see cref="SubFileSystem" /> would
