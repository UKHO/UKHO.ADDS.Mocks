...
namespace UKHO.ADDS.Mocks.Domain.Files.FileSystems
{
    ...
    public class AggregateFileSystem : ReadOnlyFileSystem
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="AggregateFileSystem" /> class with a default
        ...
        /// <param name="owned">
        ///     True if <paramref name="fileSystem" /> and other filesystems should be disposed when this instance
        ///     is disposed.
        /// </param>
        ...
        /// <summary>
        ///     Gets an ordered list of the filesystems registered to this instance. The backup filesystem passed to the
        ///     constructor
        ///     is not part of the liset.
        /// </summary>
        public List<IFileSystem> GetFileSystems() => new(_fileSystems);
        ...
        /// <summary>
        ///     Sets the filesystems by clearing all previously registered filesystems, from the lowest to highest priority
        ///     filesystem.
        /// </summary>
        ...
        /// <summary>
        ///     Adds a filesystem to this aggregate view. The Last filesystem as more priority than the previous one when an
        ///     overrides
        ///     of a file occurs.
        /// </summary>
        ...
        /// <summary>
        ///     Finds the first <see cref="FileSystemEntry" /> from this aggregate system found at the specified path for each
        ///     registered filesystems (in order).
        ///     The type of the first entry (file or directory) dictates the type of the following entries in the list (e.g if a
        ///     file is coming first, only files will be showned for the specified path).
        /// </summary>
        ...
        public FileSystemEntry? FindFirstFileSystemEntry(UPath path)
        {
            ...
            return pathItem.IsFile ? new FileEntry(pathItem.FileSystem, pathItem.Path) : new DirectoryEntry(pathItem.FileSystem, pathItem.Path);
        }

        /// <summary>
        ///     Finds the list of <see cref="FileSystemEntry" /> for each file or directory found at the specified path for each
        ///     registered filesystems (in order).
        ///     The type of the first entry (file or directory) dictates the type of the following entries in the list (e.g if a
        ///     file is coming first, only files will be showned for the specified path).
        /// </summary>
        ...
        private sealed class DebuggerProxy
        {
            ...
            public DebuggerProxy(AggregateFileSystem fs) => _fs = fs;

            [DebuggerBrowsable(DebuggerBrowsableState.RootHidden)] public IFileSystem[] FileSystems => _fs._fileSystems.ToArray();
