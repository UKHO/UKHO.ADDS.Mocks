...
namespace UKHO.ADDS.Mocks.Domain.Files
{
    ...
    public static class FileSystemExtensions
    {
        ...
        /// </remarks>
        public static void CopyTo(this IFileSystem fs, IFileSystem destFileSystem, UPath dstFolder, bool overwrite) => CopyTo(fs, destFileSystem, dstFolder, overwrite, true);
        ...
        ///     `true` to copy the attributes of the source file system if filesystem source and
        ///     destination are different, false otherwise.
        /// </param>
        ...
        ///     By default, this method copy attributes from source files. Use the overload method to disable this.
        /// </remarks>
        public static void CopyDirectory(this IFileSystem fs, UPath srcFolder, IFileSystem destFileSystem, UPath dstFolder, bool overwrite) => CopyDirectory(fs, srcFolder, destFileSystem, dstFolder, overwrite, true);
        ...
        public static void CopyDirectory(this IFileSystem fs, UPath srcFolder, IFileSystem destFileSystem, UPath dstFolder, bool overwrite, bool copyAttributes)
        {
            ...
            var deltaSubString = srcFolder == UPath.Root ? 0 : 1;
        ...
        ///     By default, this method copy attributes from source files. Use the overload method to disable this.
        /// </remarks>
        public static void CopyFileCross(this IFileSystem fs, UPath srcPath, IFileSystem destFileSystem, UPath destPath, bool overwrite) => CopyFileCross(fs, srcPath, destFileSystem, destPath, overwrite, true);
        ...
        ///     use the
        ///     <see
        ///         cref="WriteAllText(UKHO.ADDS.Mocks.Domain.Files.IFileSystem,UKHO.ADDS.Mocks.Domain.Files.UPath,string,System.Text.Encoding)" />
        ///     method overload with UTF8 encoding.
        /// </remarks>
        ...
        ///     path.
        /// </returns>
        public static IEnumerable<UPath> EnumerateDirectories(this IFileSystem fileSystem, UPath path) => EnumerateDirectories(fileSystem, path, "*");
        ...
        ///     The search string to match against the names of directories in path. This parameter can contain a combination
        ///     of valid literal path and wildcard (* and ?) characters (see Remarks), but doesn't support regular expressions.
        /// </param>
        /// <returns>
        ///     An enumerable collection of the full names (including paths) for the directories in the directory specified by
        ///     path.
        ...
        ///     One of the enumeration values that specifies whether the search operation should include only the current directory
        ...
        public static IEnumerable<UPath> EnumerateFiles(this IFileSystem fileSystem, UPath path) => EnumerateFiles(fileSystem, path, "*");
        ...
        /// <returns>
        ///     An enumerable collection of the full names (including paths) for the files and directories in the directory
        ///     specified by path.
        /// </returns>
        public static IEnumerable<UPath> EnumeratePaths(this IFileSystem fileSystem, UPath path) => EnumeratePaths(fileSystem, path, "*");
        ...
        public static IEnumerable<FileEntry> EnumerateFileEntries(this IFileSystem fileSystem, UPath path) => EnumerateFileEntries(fileSystem, path, "*");
        ...
        public static IEnumerable<DirectoryEntry> EnumerateDirectoryEntries(this IFileSystem fileSystem, UPath path) => EnumerateDirectoryEntries(fileSystem, path, "*");
        ...
        public static IEnumerable<FileSystemEntry> EnumerateFileSystemEntries(this IFileSystem fileSystem, UPath path) => EnumerateFileSystemEntries(fileSystem, path, "*");
        ...
        ///     <see cref="SearchTarget.Directory" /> or <see cref="SearchTarget.File" />. Default is
        ///     <see cref="SearchTarget.Both" />
        /// </param>
        /// <returns>An enumerable collection of <see cref="FileSystemEntry" /> that match a search pattern in a specified path.</returns>
        public static IEnumerable<FileSystemEntry> EnumerateFileSystemEntries(this IFileSystem fileSystem, UPath path, string searchPattern, SearchOption searchOption, SearchTarget searchTarget = SearchTarget.Both)
        {
            ...
            {
                yield return fileSystem.DirectoryExists(subPath) ? new DirectoryEntry(fileSystem, subPath) : new FileEntry(fileSystem, subPath);
            }
        }

        /// <summary>
        ///     Gets a <see cref="FileSystemEntry" /> for the specified path. If the file or directory does not exist, throws a
        ...
        /// <summary>
        ///     Tries to get a <see cref="FileSystemEntry" /> for the specified path. If the file or directory does not exist,
        ///     returns null.
        /// </summary>
        /// <param name="fileSystem">The file system.</param>
        /// <param name="path">The file or directory path.</param>
        ...
        /// <summary>
        ///     Gets a <see cref="FileEntry" /> for the specified path. If the file does not exist, throws a
        ///     <see cref="FileNotFoundException" />
        /// </summary>
        /// <param name="fileSystem">The file system.</param>
        ...
        /// <summary>
        ///     Gets a <see cref="DirectoryEntry" /> for the specified path. If the file does not exist, throws a
