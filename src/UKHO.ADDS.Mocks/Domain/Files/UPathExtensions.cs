namespace UKHO.ADDS.Mocks.Domain.Files
{
    ...
    {
        /// <summary>
        ///     Converts the specified path to a relative path (by removing the leading `/`). If the path is already relative,
        ///     returns the input.
        /// </summary>
        ...
        /// <summary>
        ///     Converts the specified path to an absolute path (by adding a leading `/`). If the path is already absolute, returns
        ///     the input.
        /// </summary>
        /// <param name="path">The path.</param>
        ...
        /// <summary>
        ///     Gets the first directory of the specified path and return the remaining path (/a/b/c, first directory: /a,
        ///     remaining: b/c)
        /// </summary>
        ...
        public static string GetName(this UPath path) => path.IsNull ? null! : Path.GetFileName(path.FullName);
        ...
        /// <returns>
        ///     The characters after the last directory character in path without the extension. If path is null, this method
        ///     returns null.
        /// </returns>
        public static string? GetNameWithoutExtension(this UPath path) => path.IsNull ? null : Path.GetFileNameWithoutExtension(path.FullName);
        ...
        /// <returns>
        ///     The extension of the specified path (including the period "."), or null, or String.Empty. If path is null,
        ///     GetExtension returns null. If path does not have extension information, GetExtension returns String.Empty..
        /// </returns>
        public static string? GetExtensionWithDot(this UPath path) => path.IsNull ? null : Path.GetExtension(path.FullName);
        ...
        public static UPath ChangeExtension(this UPath path, string extension) => new(Path.ChangeExtension(path.FullName, extension));
        ...
        ///     True to check if it is anywhere in the directory, false to check if it is directly in the
        ///     directory.
        /// </param>
        ...
        ///     If the path was null using the parameter name from
        ///     <paramref name="name" />
        /// </exception>
        ...
        ///     If the path is not absolute using the parameter name from
        ///     <paramref name="name" />
        /// </exception>
