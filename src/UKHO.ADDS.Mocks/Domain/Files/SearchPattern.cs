...
namespace UKHO.ADDS.Mocks.Domain.Files
{
    ...
    public struct SearchPattern
    {
        ...
        /// <returns>
        ///     An instance of <see cref="SearchPattern" /> in order to use
        ///     <see cref="Match(UKHO.ADDS.Mocks.Domain.Files.UPath)" /> on a path.
        /// </returns>
        public static SearchPattern Parse(ref UPath path, ref string searchPattern) => new(ref path, ref searchPattern);
        ...
        /// <param name="path">The path.</param>
        /// <param name="searchPattern">The search pattern.</param>
        public static void Normalize(ref UPath path, ref string searchPattern) => Parse(ref path, ref searchPattern);
